...
#include "../SPI_EtherCAT_slave_stack/mailbox.h"

#include "../SPI_EtherCAT_slave_stack/ecatcoe.h"
#include "../SPI_EtherCAT_slave_stack/objdef.h"



#include "../SPI_EtherCAT_slave_stack/TMDSECATCNCD379D-EchoBack.h"
